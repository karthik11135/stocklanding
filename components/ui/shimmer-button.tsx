  ...
  (
    ...
    return (
      ...
      >
        ...
        >
          {/* spark */}
          <div className="absolute inset-0 h-[120cqh] animate-shimmer-slide [aspect-ratio:1] [border-radius:0] [mask:none]">
            {/* spark before */}
        ...
        <div
          className={`${
            backDropClassName ? backDropClassName : '[background:var(--bg)]'
